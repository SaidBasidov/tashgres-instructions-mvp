...
export const messages = {
  ru: {
    ...
    search: {
      ...
      searchLoadingTitle: "Ищем подходящие инструкции",
      searchLoadingDescription: "Анализируем документы и разделы",
      searchEmptyTitle: "Ничего не найдено",
      searchEmptyDescription: "Попробуйте изменить формулировку или использовать другие ключевые слова",
      searchErrorTitle: "Не удалось выполнить поиск",
      searchErrorDescription: "Попробуйте повторить запрос",
  ...
  uzLatn: {
    ...
    search: {
      ...
      searchLoadingTitle: "Mos yo‘riqnomalarni qidirmoqdamiz",
      searchLoadingDescription: "Hujjatlar va bo‘limlarni tahlil qilmoqdamiz",
      searchEmptyTitle: "Hech narsa topilmadi",
      searchEmptyDescription: "So‘rovni boshqacha yozib ko‘ring yoki boshqa kalit so‘zlardan foydalaning",
      searchErrorTitle: "Qidiruvni bajarib bo‘lmadi",
      searchErrorDescription: "So‘rovni qayta yuborib ko‘ring",
  ...
  uzCyrl: {
    ...
    search: {
      ...
      searchLoadingTitle: "Мос йўриқномаларни қидирмоқдамиз",
      searchLoadingDescription: "Ҳужжатлар ва бўлимларни таҳлил қилмоқдамиз",
      searchEmptyTitle: "Ҳеч нарса топилмади",
      searchEmptyDescription: "Сўровни бошқача ёзиб кўринг ёки бошқа калит сўзлардан фойдаланинг",
      searchErrorTitle: "Қидирувни бажариб бўлмади",
      searchErrorDescription: "Сўровни қайта юбориб кўринг",
